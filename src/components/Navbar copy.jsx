...
export default function Navbar() {
  ...
  return (
    <div className="navbar bg-green-700 shadow-lg px-4 sm:fixed top-0 left-0 right-0 z-50 h-16">
      ...
      {/* <ul className={`
        ...
        <li>
          <NavItem to="/dashboard" onClick={handleLinkClick} className={dropdownLinkClass}>
            Dashbord
          </NavItem>
        </li>
        <li>
