    ...
    <div className="flex flex-col flex-grow items-center text-center w-full relative">
        ...
        >
            <h2 className="leading-relaxed">
                ...
                <br />
                leaves, fruits, vegetables, eggs, plants ...
                <br />
            ...
            <h2 className="leading-relaxed">
                With this app you can easily let people
                <br />
                know what, when and how many
                <br />
                you have to share or need.
                <br />
                Give locally is a nice way
                <br /> 
                to reduce waste.
